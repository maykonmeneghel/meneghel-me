 ...
 *
 * The eight stages are the eight chapters before this one, in order, and the
 * numbers are the ones those chapters already established: the same MQTT topic,
...
export type StageId =
  ...
  | 'service' | 'swarm' | 'mind' | 'glass';

export interface Stage {
  id: StageId;
  /** Chapter anchor, so the finale doubles as a way back. */
  href: string;
 ...
 */
export const SILENT_FAILURES: StageId[] = ['steel', 'mind'];
