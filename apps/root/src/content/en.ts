...
export const en: RootContent = {
  ...
  now: {
    ...
    people: [
      ...
      { slug: 'bebel', name: 'Bebel', role: 'The dog', gift: 'Yorkshire terrier, {age} years old, and everywhere in this house for a decade — including inside an app I built, where she ended up as the sample profile.' },
  ...
  footer: 'Made at home, in Curitiba — Paraná, Brazil.',
};
